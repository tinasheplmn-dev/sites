...
(function () {
  ...
  function lees(soort) { try { return JSON.parse(localStorage.getItem('rhodos-demo-' + soort)) || []; } catch (e) { return []; } }
  function schrijf(soort, lijst) { try { localStorage.setItem('rhodos-demo-' + soort, JSON.stringify(lijst)); } catch (e) {} }

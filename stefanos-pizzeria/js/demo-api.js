...
(function () {
  ...
  function lees(soort) { try { return JSON.parse(localStorage.getItem('stefanos-pizzeria-demo-' + soort)) || []; } catch (e) { return []; } }
  function schrijf(soort, lijst) { try { localStorage.setItem('stefanos-pizzeria-demo-' + soort, JSON.stringify(lijst)); } catch (e) {} }

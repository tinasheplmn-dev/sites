...
(function () {
  ...
  function lees(soort) { try { return JSON.parse(localStorage.getItem('friethuys-kwibus-demo-' + soort)) || []; } catch (e) { return []; } }
  function schrijf(soort, lijst) { try { localStorage.setItem('friethuys-kwibus-demo-' + soort, JSON.stringify(lijst)); } catch (e) {} }

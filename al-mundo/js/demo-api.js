...
(function () {
  ...
  function lees(soort) { try { return JSON.parse(localStorage.getItem('al-mundo-demo-' + soort)) || []; } catch (e) { return []; } }
  function schrijf(soort, lijst) { try { localStorage.setItem('al-mundo-demo-' + soort, JSON.stringify(lijst)); } catch (e) {} }

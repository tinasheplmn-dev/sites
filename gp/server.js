/* Simpele statische server voor lokale preview. Productie heeft dit niet nodig:
   de site is volledig statisch en kan op elke host die nette URL's ondersteunt
   (of met .html-herschrijving, zie README). */
...
}).listen(PORT, () => console.log('Rijschool GP preview op http://localhost:' + PORT));

...
(function () {
  ...
  function lees(soort) { try { return JSON.parse(localStorage.getItem('nour-doner-demo-' + soort)) || []; } catch (e) { return []; } }
  function schrijf(soort, lijst) { try { localStorage.setItem('nour-doner-demo-' + soort, JSON.stringify(lijst)); } catch (e) {} }

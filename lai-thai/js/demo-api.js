...
(function () {
  ...
  function lees(soort) { try { return JSON.parse(localStorage.getItem('lai-thai-demo-' + soort)) || []; } catch (e) { return []; } }
  function schrijf(soort, lijst) { try { localStorage.setItem('lai-thai-demo-' + soort, JSON.stringify(lijst)); } catch (e) {} }

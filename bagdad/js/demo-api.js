...
(function () {
  ...
  function lees(soort) { try { return JSON.parse(localStorage.getItem('bagdad-demo-' + soort)) || []; } catch (e) { return []; } }
  function schrijf(soort, lijst) { try { localStorage.setItem('bagdad-demo-' + soort, JSON.stringify(lijst)); } catch (e) {} }

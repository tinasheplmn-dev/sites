...
(function () {
  ...
  function lees(soort) { try { return JSON.parse(localStorage.getItem('basak-doner-demo-' + soort)) || []; } catch (e) { return []; } }
  function schrijf(soort, lijst) { try { localStorage.setItem('basak-doner-demo-' + soort, JSON.stringify(lijst)); } catch (e) {} }

...
(function () {
  ...
  function lees(soort) { try { return JSON.parse(localStorage.getItem('rancho-demo-' + soort)) || []; } catch (e) { return []; } }
  function schrijf(soort, lijst) { try { localStorage.setItem('rancho-demo-' + soort, JSON.stringify(lijst)); } catch (e) {} }
